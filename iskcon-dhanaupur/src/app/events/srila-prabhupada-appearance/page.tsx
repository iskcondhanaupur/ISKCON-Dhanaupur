...
import AppearanceDayView from '@/components/views/AppearenceDayView'
import { content, Lang } from '@/data/content'

export default function SrilaPrabhupadaAppearancePage() {
  ...
  return (
    <div className="page-root">
      ...
      <main style={{ flex: 1, paddingTop: 68 }}>
        <AppearanceDayView lang={lang} onBack={() => router.push('/events')} />
      </main>
