...
import HouseProgramsView from '@/components/views/HouseProgramsView'
import { content, Lang } from '@/data/content'

export default function HouseProgramsPage() {
  ...
  return (
    <div className="page-root">
      ...
      <main style={{ flex: 1, paddingTop: 68 }}>
        <HouseProgramsView t={t} lang={lang} onBack={() => router.push('/menu')} />
      </main>
