...
import GokuldhamPratiyogitaView from '@/components/views/GokuldhampratiyogitaView'
import { content, Lang } from '@/data/content'

export default function GokuldhamPratiyogitaPage() {
  ...
  return (
    <div className="page-root">
      ...
      <main style={{ flex: 1, paddingTop: 68 }}>
        <GokuldhamPratiyogitaView lang={lang} onBack={() => router.back()} />
      </main>
